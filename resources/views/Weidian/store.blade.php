...
<div class="container">
    ...
    <ul id="goods-list" class="goods-list">
        <li>
            <div class="pic" data-id="123" data-url="#">
            ...
            <p class="btn-box">
                <i class="icon-sale-down"></i>
                <i class="icon-text-scheme"></i>
                <i class="icon-share"></i>
                <i data-url="images/pages/mmexport1487757957079.jpg" class="icon-er-code"></i>
            </p>
        </li>
        <li>
            <div class="pic" data-id="124" data-url="#">
                <img src="http://youam.yunyiwd.com/user_res/upload/temp/201607/28/476513704833221395_thumbnail.jpg" alt="">
            </div>
            <p class="goods-desc">远大空气净化机TB400&nbsp;专业净化&nbsp;静电除菌&nbsp;消除甲醛&nbsp;三层过滤&nbsp;&nbsp;缺氧监测使用面积40-60方&nbsp;包邮</p>
            <p>
        ...
        <li>
            <div class="pic" data-id="125" data-url="#">
                <img src="http://youam.yunyiwd.com/user_res/upload/temp/201607/28/476513704833221395_thumbnail.jpg" alt="">
            </div>
            <p class="goods-desc">远大空气净化机TB400&nbsp;专业净化&nbsp;静电除菌&nbsp;消除甲醛&nbsp;三层过滤&nbsp;&nbsp;缺氧监测使用面积40-60方&nbsp;包邮</p>
            <p>
        ...
        <li>
            <div class="pic" data-id="126" data-url="#">
                <img src="http://youam.yunyiwd.com/user_res/upload/temp/201607/28/476513704833221395_thumbnail.jpg" alt="">
            </div>
            <p class="goods-desc">远大空气净化机TB400&nbsp;专业净化&nbsp;静电除菌&nbsp;消除甲醛&nbsp;三层过滤&nbsp;&nbsp;缺氧监测使用面积40-60方&nbsp;包邮</p>
            <p>
        ...
        <li>
            <div class="pic" data-id="127" data-url="#">
                <img src="http://youam.yunyiwd.com/user_res/upload/temp/201607/28/476513704833221395_thumbnail.jpg" alt="">
            </div>
            <p class="goods-desc">远大空气净化机TB400&nbsp;专业净化&nbsp;静电除菌&nbsp;消除甲醛&nbsp;三层过滤&nbsp;&nbsp;缺氧监测使用面积40-60方&nbsp;包邮</p>
            <p>
        ...
        <li>
            <div class="pic" data-id="128" data-url="#">
                <img src="http://youam.yunyiwd.com/user_res/upload/temp/201607/28/476513704833221395_thumbnail.jpg" alt="">
            </div>
            <p class="goods-desc">远大空气净化机TB400&nbsp;专业净化&nbsp;静电除菌&nbsp;消除甲醛&nbsp;三层过滤&nbsp;&nbsp;缺氧监测使用面积40-60方&nbsp;包邮</p>
            <p>
